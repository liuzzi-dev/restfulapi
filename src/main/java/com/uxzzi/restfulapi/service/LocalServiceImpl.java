...
import com.uxzzi.restfulapi.repository.LocalRepository;
...
public class LocalServiceImpl implements LocalService{
    ...
    @Override
    public List<Local> findByNameIgnoreCaseStartingWith(String name) {
        return localRepository.findByNameIgnoreCaseStartingWith(name);
    }
